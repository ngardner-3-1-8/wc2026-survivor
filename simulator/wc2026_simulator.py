...
TEAMS = [
    Team("Mexico", "A", att=0.99, defe=0.6, fifa_rank=15),
    Team("South Africa", "A", att=1.07, defe=0.88, fifa_rank=60),
    Team("South Korea", "A", att=1.43, defe=1.25, fifa_rank=25),
    Team("Czechia", "A", att=1.05, defe=0.94, fifa_rank=41),
    Team("Switzerland", "B", att=1.36, defe=0.69, fifa_rank=19),
    Team("Canada", "B", att=1.12, defe=0.76, fifa_rank=30),
    Team("Qatar", "B", att=1.27, defe=0.68, fifa_rank=55),
    Team("Bosnia", "B", att=1.0, defe=0.97, fifa_rank=65),
    Team("Brazil", "C", att=1.14, defe=0.75, fifa_rank=6),
    Team("Morocco", "C", att=1.65, defe=0.55, fifa_rank=8),
    Team("Scotland", "C", att=1.06, defe=1.26, fifa_rank=43),
    Team("Haiti", "C", att=1.04, defe=1.1, fifa_rank=83),
    Team("USA", "D", att=1.31, defe=0.79, fifa_rank=16),
    Team("Türkiye", "D", att=1.15, defe=0.9, fifa_rank=22),
    Team("Australia", "D", att=1.19, defe=0.64, fifa_rank=27),
    Team("Paraguay", "D", att=0.78, defe=0.94, fifa_rank=40),
    Team("Germany", "E", att=1.65, defe=0.67, fifa_rank=10),
    Team("Ecuador", "E", att=0.86, defe=0.62, fifa_rank=23),
    Team("Ivory Coast", "E", att=1.59, defe=0.55, fifa_rank=34),
    Team("Curaçao", "E", att=1.28, defe=0.8, fifa_rank=82),
    Team("Netherlands", "F", att=1.56, defe=0.8, fifa_rank=7),
    Team("Japan", "F", att=1.63, defe=1.16, fifa_rank=18),
    Team("Sweden", "F", att=0.71, defe=1.3, fifa_rank=38),
    Team("Tunisia", "F", att=1.43, defe=0.55, fifa_rank=44),
    Team("Belgium", "G", att=1.53, defe=0.67, fifa_rank=9),
    Team("Iran", "G", att=1.44, defe=0.87, fifa_rank=21),
    Team("Egypt", "G", att=1.37, defe=0.55, fifa_rank=29),
    Team("New Zealand", "G", att=0.78, defe=1.1, fifa_rank=85),
    Team("Spain", "H", att=1.65, defe=0.55, fifa_rank=2),
    Team("Uruguay", "H", att=1.18, defe=0.68, fifa_rank=17),
    Team("Saudi Arabia", "H", att=0.79, defe=0.75, fifa_rank=61),
    Team("Cape Verde", "H", att=0.82, defe=1.08, fifa_rank=69),
    Team("France", "I", att=1.24, defe=0.56, fifa_rank=1),
    Team("Senegal", "I", att=1.5, defe=0.55, fifa_rank=14),
    Team("Norway", "I", att=1.65, defe=0.71, fifa_rank=31),
    Team("Iraq", "I", att=1.59, defe=1.2, fifa_rank=57),
    Team("Argentina", "J", att=1.31, defe=0.55, fifa_rank=3),
    Team("Algeria", "J", att=1.56, defe=0.79, fifa_rank=28),
    Team("Austria", "J", att=1.54, defe=0.84, fifa_rank=24),
    Team("Jordan", "J", att=1.27, defe=0.96, fifa_rank=63),
    Team("Portugal", "K", att=1.52, defe=0.78, fifa_rank=5),
    Team("Colombia", "K", att=1.27, defe=0.78, fifa_rank=13),
    Team("Uzbekistan", "K", att=1.02, defe=0.67, fifa_rank=50),
    Team("DR Congo", "K", att=0.85, defe=1.06, fifa_rank=46),
    Team("England", "L", att=1.36, defe=0.55, fifa_rank=4),
    Team("Croatia", "L", att=1.45, defe=0.98, fifa_rank=11),
    Team("Panama", "L", att=1.44, defe=0.95, fifa_rank=33),
    Team("Ghana", "L", att=1.43, defe=0.75, fifa_rank=74),
]
# fmt: on
