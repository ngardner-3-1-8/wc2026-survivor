...
TEAMS = [
    Team("Mexico", "A", att=1.03, defe=0.71, fifa_rank=15),
    Team("South Africa", "A", att=1.0, defe=0.95, fifa_rank=60),
    Team("South Korea", "A", att=1.3, defe=1.16, fifa_rank=25),
    Team("Czechia", "A", att=1.05, defe=0.94, fifa_rank=41),
    Team("Switzerland", "B", att=1.26, defe=0.78, fifa_rank=19),
    Team("Canada", "B", att=1.08, defe=0.85, fifa_rank=30),
    Team("Qatar", "B", att=1.2, defe=0.78, fifa_rank=35),
    Team("Bosnia", "B", att=1.0, defe=0.97, fifa_rank=52),
    Team("Brazil", "C", att=1.17, defe=0.78, fifa_rank=6),
    Team("Morocco", "C", att=1.59, defe=0.61, fifa_rank=8),
    Team("Scotland", "C", att=1.01, defe=1.2, fifa_rank=47),
    Team("Haiti", "C", att=0.96, defe=1.12, fifa_rank=83),
    Team("USA", "D", att=1.24, defe=0.84, fifa_rank=16),
    Team("Türkiye", "D", att=1.15, defe=0.9, fifa_rank=42),
    Team("Australia", "D", att=1.14, defe=0.76, fifa_rank=26),
    Team("Paraguay", "D", att=0.78, defe=1.02, fifa_rank=64),
    Team("Germany", "E", att=1.5, defe=0.74, fifa_rank=10),
    Team("Ecuador", "E", att=0.92, defe=0.74, fifa_rank=24),
    Team("Ivory Coast", "E", att=1.39, defe=0.61, fifa_rank=33),
    Team("Curaçao", "E", att=1.12, defe=0.92, fifa_rank=81),
    Team("Netherlands", "F", att=1.44, defe=0.82, fifa_rank=7),
    Team("Japan", "F", att=1.45, defe=1.09, fifa_rank=18),
    Team("Sweden", "F", att=0.79, defe=1.27, fifa_rank=39),
    Team("Tunisia", "F", att=1.28, defe=0.63, fifa_rank=40),
    Team("Belgium", "G", att=1.41, defe=0.75, fifa_rank=9),
    Team("Iran", "G", att=1.31, defe=0.9, fifa_rank=21),
    Team("Egypt", "G", att=1.25, defe=0.67, fifa_rank=29),
    Team("New Zealand", "G", att=0.78, defe=1.1, fifa_rank=95),
    Team("Spain", "H", att=1.61, defe=0.59, fifa_rank=2),
    Team("Uruguay", "H", att=1.16, defe=0.77, fifa_rank=17),
    Team("Saudi Arabia", "H", att=0.83, defe=0.87, fifa_rank=57),
    Team("Cape Verde", "H", att=0.82, defe=1.08, fifa_rank=70),
    Team("France", "I", att=1.28, defe=0.63, fifa_rank=1),
    Team("Senegal", "I", att=1.38, defe=0.65, fifa_rank=14),
    Team("Norway", "I", att=1.65, defe=0.84, fifa_rank=44),
    Team("Iraq", "I", att=1.34, defe=1.17, fifa_rank=61),
    Team("Argentina", "J", att=1.3, defe=0.62, fifa_rank=3),
    Team("Algeria", "J", att=1.35, defe=0.88, fifa_rank=36),
    Team("Austria", "J", att=1.38, defe=0.89, fifa_rank=23),
    Team("Jordan", "J", att=1.12, defe=1.02, fifa_rank=68),
    Team("Portugal", "K", att=1.43, defe=0.8, fifa_rank=5),
    Team("Colombia", "K", att=1.22, defe=0.82, fifa_rank=13),
    Team("Uzbekistan", "K", att=0.96, defe=0.83, fifa_rank=62),
    Team("DR Congo", "K", att=0.85, defe=1.06, fifa_rank=51),
    Team("England", "L", att=1.32, defe=0.62, fifa_rank=4),
    Team("Croatia", "L", att=1.35, defe=0.96, fifa_rank=11),
    Team("Panama", "L", att=1.23, defe=1.01, fifa_rank=53),
    Team("Ghana", "L", att=1.25, defe=0.87, fifa_rank=65),
]
# fmt: on
